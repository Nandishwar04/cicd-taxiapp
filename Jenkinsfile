def registry = 'https://taxi10.jfrog.io/artifactory'
def imageName = 'taxi10.jfrog.io/taxi01-docker-local/taxiapp'
def version   = '1.0.1' 
pipeline {
    agent {
        node {
        ...
        stage('SonarQube Analysis') {
            steps {
                script {
                    ...
                    -Dsonar.projectKey=taxi-app10_taxi \
                    -Dsonar.organization=taxi-app10 \
